...
async def get_dashboard(request: Request):
    ...
    departments = [
        "OQA", "PE", "R&D", "QC", "Production", "Warehouse",
        "Purchasing", "Planning", "Logistics", "Maintenance",
        "HR", "Admin", "IT"
    ]
    ...
    return templates.TemplateResponse(
        request=request,
        name="index.html", 
        context={"departments": departments, "current_user": dict(user), "models": models, "active_models": active_models}
    )
